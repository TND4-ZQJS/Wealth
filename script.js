<script>
    function calculateCommission() {
        ...
        table += `</table></div>
                  <h3>Total Earnings: RM <strong>${formatNumber(totalEarnings)}</strong></h3>
                  <p>Do you want to see the harvesting of being a new leader?</p>
                  <button onclick="goToLeaderBonus(${totalEarnings})">Let’s Dream</button>`;
    ...
    function goToLeaderBonus(totalEarnings) {
        window.location.href = `leader_bonus.html?earnings=${totalEarnings}`;
    }
</script>